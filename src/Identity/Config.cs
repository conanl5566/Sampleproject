...
namespace CompanyName.ProjectName.IdentityServer
{
    public static class Config
    {
        ...
        public static IEnumerable<ApiResource> GetApis()
        {
            return new[]
            {
                new ApiResource("CompanyName.ProjectNameapi", "CompanyName.ProjectName.WebApi")
                {
        ...
        public static IEnumerable<Client> GetClients(string identityUrl)
        {
            ...
            //if (isProduction)
            //{
            //    host = "http://demo.CompanyName.ProjectName.me";  //切换为自己的服务器信息
            //}
            return new[]
            {
                //new Client
                //{
                //    ClientId = "CompanyName.ProjectName.WebApi",//客户端名称
                ...
                //    },
                //    AllowedScopes = { "CompanyName.ProjectNameapi" }
                //},
                new Client
                {
                    ClientId = "CompanyName.ProjectName.Mvc",
                    ClientName = "开源版mvc认证",
